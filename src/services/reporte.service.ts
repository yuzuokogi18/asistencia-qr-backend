      ...
      try {
        ...
        for (let pageIdx = 0; pageIdx < totalPages; pageIdx++) {
          ...
          doc.fillColor('#64748b')
            ...
            .font('Helvetica')
            .text(
              `PLANTILLA OFICIAL DE CREDENCIALES • GRUPO: ${grupo.nombre} (${grupo.grado} - TURNO ${grupo.turno.toUpperCase()}) • CICLO ${config.school.cycle} • PÁGINA ${pageIdx + 1} DE ${totalPages}`,
              28,
              22,
          ...
          for (let slot = 0; slot < pageAlumnos.length; slot++) {
            ...
            doc.fillColor('#93c5fd')
              .fontSize(6)
              .font('Helvetica')
              .text(`CREDENCIAL OFICIAL • CICLO ${config.school.cycle}`, headerTextX, y + 19);
            ...
            doc.fillColor('#0f172a').fontSize(7).font('Helvetica-Bold').text(config.school.cycle, dataX + 54, y + 119);
