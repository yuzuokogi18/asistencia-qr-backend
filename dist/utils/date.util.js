...
exports.getDiasLaboralesSemana = exports.getRangoSemanaLaboral = exports.getTiempoRelativo = exports.compareHoras = exports.parseFechaStr = exports.getHoraActualStr = exports.getFechaActualStr = void 0;
const getFechaActualStr = (date = new Date()) => {
    const y = date.getFullYear();
    const m = String(date.getMonth() + 1).padStart(2, '0');
    const d = String(date.getDate()).padStart(2, '0');
    return `${y}-${m}-${d}`;
};
exports.getFechaActualStr = getFechaActualStr;
const getHoraActualStr = (date = new Date()) => {
    const h = String(date.getHours()).padStart(2, '0');
    const m = String(date.getMinutes()).padStart(2, '0');
    const s = String(date.getSeconds()).padStart(2, '0');
    return `${h}:${m}:${s}`;
};
exports.getHoraActualStr = getHoraActualStr;
/**
...
exports.getTiempoRelativo = getTiempoRelativo;
/**
 * Obtiene el lunes y viernes de la semana correspondiente a una fecha
 */
const getRangoSemanaLaboral = (fecha = new Date()) => {
...
exports.getRangoSemanaLaboral = getRangoSemanaLaboral;
/**
 * Obtiene los 5 días laborales (Lunes a Viernes) de la semana actual en strings "YYYY-MM-DD"
 */
const getDiasLaboralesSemana = (fecha = new Date()) => {
    const { lunes } = (0, exports.getRangoSemanaLaboral)(fecha);
    const dias = [];
    for (let i = 0; i < 5; i++) {
        const dia = new Date(lunes);
        dia.setDate(lunes.getDate() + i);
        dias.push((0, exports.getFechaActualStr)(dia));
    }
    return dias;
};
exports.getDiasLaboralesSemana = getDiasLaboralesSemana;
